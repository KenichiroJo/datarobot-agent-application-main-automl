...
PREDICTION_DEPLOYMENT_ID: Final[str] = "PREDICTION_DEPLOYMENT_ID"
prediction_deployment_id = os.environ.get(PREDICTION_DEPLOYMENT_ID, "")

SCORING_DATASET_ID: Final[str] = "SCORING_DATASET_ID"
...
fastapi_server_app_runtime_parameters: list[
    ...
    + [
        ...
        pulumi_datarobot.ApplicationSourceRuntimeParameterValueArgs(
            type="string",
            key=PREDICTION_DEPLOYMENT_ID,
            value=prediction_deployment_id,
        ),
        pulumi_datarobot.ApplicationSourceRuntimeParameterValueArgs(
            type="string",
            key=SCORING_DATASET_ID,
            value=scoring_dataset_id,
        ),
    ]
)
